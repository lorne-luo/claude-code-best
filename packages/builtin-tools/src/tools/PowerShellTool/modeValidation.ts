...
export function checkPermissionMode(
  ...
  // Example: `Set-Location ./.claude; Set-Content ./settings.open.json '...'` — the validator
  // sees ./settings.open.json as /project/settings.open.json, but PowerShell writes to
  // /project/.claude/settings.open.json. Refuse to auto-allow any write operation in a
